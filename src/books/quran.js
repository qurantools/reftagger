...
const CHAPTER_REFS = [
  ...
  ["al-baqarah", "the cow"],
  ["ali 'imran", "ali ’imran", "family of imran"],
  ["an-nisa", "the women"],
  ["al-ma'idah", "al-ma’idah", "the table spread"],
  ...
  ["al-waqi'ah", "al-waqi’ah", "the inevitable"],
  ["al-hadid", "the iron"],
  ["al-mujadila", "the pleading woman"],
  ["al-hashr", "the exile"],
  ["al-mumtahanah", "she that is to be examined"],
  ["as-saf", "the ranks"],
  ["al-jumu'ah", "al-jumu’ah", "the congregation, friday"],
  ...
  ["al-ma'arij", "al-ma’arij", "the ascending stairways"],
  ["nuh", "noah"],
  ["al-jinn", "the jinn"],
  ...
  ["an-naba", "the tidings"],
  ["an-nazi'at", "an-nazi’at", "those who drag forth"],
  ...
  ["at-tin", "the fig"],
  ["al-'alaq", "al-’alaq", "the clot"],
  ["al-qadr", "the power"],
  ["al-bayyinah", "the clear proof"],
  ["az-zalzalah", "the earthquake"],
  ["al-'adiyat", "al-’adiyat", "the courser"],
  ["al-qari'ah", "al-qari’ah", "the calamity"],
  ["at-takathur", "the rivalry in world increase"],
  ["al-'asr", "al-’asr", "the declining day"],
  ["al-humazah", "the traducer"],
  ["al-fil", "the elephant"],
  ["quraysh", "quraysh"],
  ["al-ma'un", "al-ma’un", "the small kindesses"],
