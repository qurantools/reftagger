const template = `
  <div id="alkotob-tooltip" style="display: none;">
    ...
    <div id="alkotob-readmore">
      <a id="alkotob-readmore-link" target="_blank" href="http://kurancalis.com">&laquo;</a>
    </div>
  </div>
`;
